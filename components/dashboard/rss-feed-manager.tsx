                    ...
                    <div className="text-center py-12">
                        ...
                        <AddFeedDialog
                            ...
                            trigger={
                                ...
                                hover:from-blue-700 hover:to-blue-700 text-white">
                                ...
                                <div className="flex items-start justify-between gap-2 sm:gap-4">
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <a
                                            ...
                                            className="text-sm text-muted-foreground hover:text-blue-600 dark:hover:text-blue-400 inline-flex
                                                items-center gap-1 mb-2 transition-colors max-w-full"
                                        >
