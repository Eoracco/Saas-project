...
const steps = [
	{
		...
		description:
			"Add up to 3RSS feeds on Starter($9/month), or unlimited with Pro($19/month). We will automatically fetch and organize content from all your sources.",
	},
	{
		number: "02",
		icon: Calendar,
							...
							return (
								<div key={step.number} className="relative">
									...
									{index < steps.length - 1 && (
										<div
											className="absolute top-12 left-1/2 hidden h-0.5 w-full
									...
									<div className="relative flex flex-col items-center text-center">
										{/* number badge */}
										<div
											className="mb-4 flex size-24 items-center justify-center
