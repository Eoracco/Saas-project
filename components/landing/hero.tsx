...
export default function Hero() {
	return (
		<section
			className="relative overflow-hidden bg-linear-to-b from-white to-gray-50 dark:from-black  dark:to-gray-950
    py-20 sm:py-32"
		>
          ...
          dark:text-white sm:text-6xl lg:text-7xl"
            ...
            bg-clip-text text-transparent"
					...
					<p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400 sm:text-xl">
						...
						fedds into engaging newsletters with perfect titles, subjext lines,
						and content.
					</p>
					{/* CTA */}
					...
					<p className="mt-8 text-sm text-gray-500 dark:text-gray-500">
						Join 1,000+ Newsletter creators saving 5+ hours every week. Staring
						at $9/month
					</p>
				</div>
						...
						<div className="relative shrink-0 w-full lg:w-auto">
							<div className="grid grid-cols-3 gap-2 lg:gap-6 max-w-xs mx-auto lg:max-w-none">
								...
								<div className="flex flex-col items-center gap-2">
									<div
										className="relative size-16 lg:size-24 rounded-full
                  bg-linear-to-br from-blue-500 to-blue-600 shadow-lg flex items-center
                  justify-center animate-pulse"
									>
										<Rss
											className="size-6 lg:size-10 text-white
                    dark:text-gray-400"
										/>
									</div>
									<span
										className="text-[10px] lg:text-xs text-gray-500
                  dark:text-gray-400"
									>
										Feed 1
									</span>
