...
export default function Hero() {
  return (
    <section className='relative overflow-hidden bg-linear-to-b from-white to-gray-50 dark:from-black  dark:to-gray-950
    py-20 sm:py-32'>
      ...
      <div className='relative mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-3xl text-center'>
          ...
          dark:text-white sm:text-6xl lg:text-7xl'>
            Generate Professional Newsletters in {" "}
            <span className='bg-linear-to-r from-blue-600 to-purple-600
          ...
          <p className='mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400 sm:text-xl'>
            Stop spending hours curating context. Let AI transform your RSS
            fedds into engaging newsletters with perfect titles, subjext lines, and content.
          </p>
          {/* CTA */}
        ...
        <div className='relative mx-auto mt-16 max-w-6xl'>
          ...
          justify-between gap-8 lg:gap-12'>
            ...
            <div className='relative shrink-0 w-full lg:w-auto'>
              <div className='grid grid-cols-3 gap-2 lg:gap-6 max-w-xs mx-auto lg:max-w-none'>
                ...
                <div className='flex flex-col items-center gap-2'>
                  <div className='relative size-16 lg:size-24 rounded-full
                  bg-linear-to-br from-blue-500 to-blue-600 shadow-lg flex items-center
                ...
                <div className='flex flex-col items-center gap-2'>
                  <div className='relative size-16 lg:size-24 rounded-full
                  bg-linear-to-br from-purple-500 to-purple-600 shadow-lg flex items-center
                  justify-center animate-pulse'>
                    <Rss className='size-6 lg:size-10 text-white
                    dark:text-gray-400'/>
                  </div>
            ...
            <div className='flex flex-col items-center gap-4 my-6 lg:my-0'>
              {/* mobile: vertival arrows poining down */}
              <div className='flex flex-col items-center gap-2 lg:hidden'>
                <ArrowDown className='size-6 text-blue-600 dark:text-blue-400 
                animate-bounce'/>
              </div>

              {/* Desktop: Horizontal arrows pointing right */}
              <div className='hidden lg:flex lg:flex-col items-center gap-2'>
                <ArrowRight className='size-10 text-blue-600 dark:text-blue-400
                animate-pulse'/>
                <ArrowRight
            ...
            <div className='flex-1 w-full'>
              <div className='rounded-xl border-2 border-blue-600
              dark:border-blue-500 bg-white dark:bg-gray-900 shadow-2xl
              overflow-hidden'>
                {/* Newsletter header */}
                ...
                <div className='p-6 space-y-4'>
                  ...
                  <div className='grid grid-cols-2 gap-2'>
                    ...
                    dark:border-gray-800 p-2 bg-blue-50 dark: bg-blue-950/30'>
                      <div className='h-2 w-3/4 rounded bg-blue-300/50 dark:bg-blue-700/50' />
                    </div>
                    <div className='rounded border border-gray-200
                    dark:border-gray-800 p-2 bg-purple-50 dark: bg-purple-950/30'>
