...
export const maxDuration = 60; //60 second

// POST / api / newsletter / prepare

// Quick metadata endpoint to check feeds and articles before Generation.
// Returns information for user feedback(toasts) without straing AI genenration.

// @returns mmmmetadate about feeds and articles to be used
...
export async function POST(req: NextRequest) {
    try {
        ...
        // get articles count without fetching full content
